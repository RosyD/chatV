...
-(void)_doSecondLogin{
    ...
    [ACUtility postNotificationName:kNetCenterLoginSuccRSNotifation object:nil];
...
-(void)loginAcucomServerWithAccount:(NSString *)account pwd:(NSString *)pwd
    ...
    if (![ASIHTTPRequest isValidNetWork]|| //没有网络或没有deviceToken
        ...
        if(_isFromUILogin){
            ...
            [ACUtility postNotificationName:kNetCenterLoginFailRSNotifation object:pDict ];
#else
...
-(BOOL)checkServerResponseCode:(enum ResponseCodeType) responseCode withResponseDic:(NSDictionary *)responseDic{
    ...
    if (responseCode == ResponseCodeType_LoginServerBusy){
        [ACUtility postNotificationName:kNetCenterLoginFailRSNotifation object:nil ];//responseDic];
...
-(void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary *)change context:(void *)context
{
    ...
    {
        ACSuit *suit = object;
        [ACUtility postNotificationName:kNetCenterSuitProgressUpdateNotifition object:suit.suitID];
    }
}
...
//            BOOL writable = [[NSFileManager defaultManager] isWritableFileAtPath:toPath];
        ...
        [ACUtility postNotificationName:kNetCenterGetSuitInfoNotifition object:nil];
    }
}
...
+(void)ERROR_AUTHORITYCHANGED_FAILED_Error_Func:(NSDictionary*)responseDic{
    [ACUtility postNotificationName:kNetCenterErrorAuthorityChangedFailed_1248 object:nil];
                   ...
                   requestMethod:(int)requestMethod
{
    ...
    if (![ASIHTTPRequest isValidNetWork])
    {
        ...
        {
            [ACUtility postNotificationName:kNetCenterNotes_Note_Upload_NoNetword_Notifition object:object];
        }
        else if (fileType == ACFile_Type_GetReadCount_Json)
        {
            ...
            [ACUtility postNotificationName:kNetCenterGetReadCountFailNotifation object:readCountArray];
        }
        return;
    }
...
//            [responseDic writeToFile:saveAddress atomically:YES];
            ...
            NSUserDefaults *defaults = [NSUserDefaults standardUserDefaults];
            ///AppG
            NSUserDefaults *defaultsTest = [[NSUserDefaults alloc]initWithSuiteName:@"group.lfglkh.shared--Test"];
                ...
                else
                {
                        ...
                        )
                    {
                        ...
                        if ([desc length] > 0)
                        {
                            ...
                            [ACUtility postNotificationName:kNetCenterResponseCodeErrorNotifation object:[NSNumber numberWithInteger:fileType]];
                        }
                        return;
                    }
                }
...
//                        [defaults setObject:firmAndDomain forKey:kFirmAndDomain];
                    ...
                    ///AppG
                    [defaultsTest setObject:userID forKey:kUserID];
                    
                    NSString* string =  [NSString stringWithFormat:@"%@/rest/apis/chat",[[ACNetCenter shareNetCenter] acucomServer]];
                    
                    [defaultsTest setObject:[[ACNetCenter shareNetCenter] acucomServer] forKey:@"appString"];
                    [defaultsTest setObject:string forKey:@"urlString"];
...
//                    [ASIHTTPRequest setSessionCookies:nil];
                    ...
                    ///AppG
                    [defaultsTest setObject:[responseDic objectForKey:kS] forKey:kS];
                    [defaultsTest setObject:[responseDic objectForKey:kAclSid] forKey:kAclSid];
                    ...
                    ///AppG
                    [defaultsTest setObject:acldomain forKey:kAclDomain];
...
//                    [ACUtility postNotificationName:kNetCenterLogoutNotifation object:nil];
...
//                            NSLog(@"%d,%d",sizeof(long long),sizeof(long));
                    ...
                    [ACUtility postNotificationName:kNetCenterSyncFinishNotifation object:nil];
                ...
                case ACFile_Type_GetContactPersonRootList:
                {
                    ...
                    [ACUtility postNotificationName:kNetCenterGetContactPersonRootListNotifation object:array];
                }
                    break;
                case ACFile_Type_GetContactPersonSubGroupList:
                {
                    ...
                    [ACUtility postNotificationName:kNetCenterGetContactPersonGroupListNotifation object:dic];
                }
                    break;
                case ACFile_Type_GetContactPersonSinglePersonList:
                {
                    ...
                    [ACUtility postNotificationName:kNetCenterGetContactPersonSingleListNotifation object:array];
                }
                    break;
                case ACFile_Type_CreateGroupChat:
                {
                    ...
                    [ACUtility postNotificationName:kNetCenterCreateGroupChatNotifation object:entity];
                }
                    break;
                case ACFile_Type_GetContactPersonSearchList:
                {
                    [ACUtility postNotificationName:kNetCenterGetContactPersonSearchListNotifation object:responseDic];
                    /*
                    ...
                    [ACUtility postNotificationName:kNetCenterGetContactPersonSearchListNotifation object:array];*/
                ...
                case ACFile_Type_GetChatMessage:
                {
                    ...
                    [ACUtility postNotificationName:kNetCenterGetChatMessageNotifation object:[NSDictionary dictionaryWithObjectsAndKeys:topicMessageArray,kMsgList,isLoadNew,kIsLoadNew, nil]];
                }
                    break;
...
//                    [ACUtility postNotificationName:kNetCenterSendMessageSuccessNotifation object:@[pFileMessage,sourceMessageID]];
                }
                    break;
                case ACFile_Type_SendAudio_Json:
                {
...
//                    [ACUtility postNotificationName:kNetCenterSendMessageSuccessNotifation object:@[message,sourceMessageID]];
                ...
                {
                    [ACUtility postNotificationName:kNetCenterDownloadStickerSuccessNotifation object:fileNameID];
                }
                    break;
                case ACFile_Type_VideoFile:
                {
                    ...
                    [ACUtility postNotificationName:kNetCenterDownloadVideoSuccessNotifation object:nil];
                }
                    break;
                case ACFile_Type_File:
                {
                    ACFileMessage *fileMsg = object;
                    fileMsg.isDownloading = NO;
                    [ACUtility postNotificationName:kNetCenterDownloadFileSuccessNotifation object:nil];
                }
                    break;
                case ACFile_Type_AudioFile:
                {
                    [ACUtility postNotificationName:kNetCenterDownloadAudioSuccessNotifation object:nil];
                }
                    break;
...
//                    ACNoteContentImageOrVideo* pVideo = object;
                ...
                {
                    [ACUtility postNotificationName:kNetCenterGetParticipantsNotifation object:responseDic];
                }
                    break;
                case ACFile_Type_AddParticipant_Json:
                {
                    [ACUtility postNotificationName:kNetCenterAddParticipantNotifation object:nil];
                }
                    break;
                case ACFile_Type_GetReadCount_Json:
                {
                    ...
                    [ACUtility postNotificationName:kNetCenterGetReadCountNotifation object:readCountArray];
                }
                    break;
                case ACFile_Type_GetSingleReadSeq_Json:
                {
                    ...
                    [ACReadSeqDB saveReadSeqToDBWithReadSeq:readSeq needUpdate:YES];
                    [ACUtility postNotificationName:kNetCenterGetSingleReadSeqNotifation object:readSeq];
                }
                    break;
...
//                    NSString *topicEntityID = fileNameID;
                    ...
                    [ACUtility postNotificationName:kNetCenterGetHadReadListNotifation object:array];
                }
                    break;
                case ACFile_Type_StickerDir_Json:
                {
                    ...
                    [ACUtility postNotificationName:kNetCenterStickerDirJsonRecvNotifation object:nil];
...
//                        [self getStickerZipWithTitle:package.title];
                ...
                case ACFile_Type_StickerZip:
                {
                    ...
                    if (isSuccess)
                    {
                        [ACUtility postNotificationName:kNetCenterStickerZipDownloadSuccNotifation object:fileNameID];
                    }
                    else
                    {
...
//                    break;
                ...
                case ACFile_Type_SendNoteOrWallboard:
                {
                    ...
                    [ACUtility postNotificationName:kNetCenterSendWallboardSuccNotifation object:noteMsg];
                ...
                case ACFile_Type_SearchNote:
                {
                    ...
                    [ACUtility postNotificationName:kNetCenterSearchNoteNotifation object:[[NSMutableArray alloc] initWithArray:pNotes]];
                }
                ...
                case ACFile_Type_SearchMessage:
                {
                    ...
                    [ACUtility postNotificationName:kNetCenterSearchMessageNotifation object:msgAndEntityDic];
                }
                    break;
                case ACFile_Type_SearchUser:
                {
                    ...
                    [ACUtility postNotificationName:kNetCenterSearchUserNotifation object:userArray];
                }
                    break;
                case ACFile_Type_SearchUserGroup:
                {
                    ...
                    [ACUtility postNotificationName:kNetCenterSearchUserGroupNotifation object:userGroupArray];
                }
                    break;
//                case ACFile_Type_SearchHighLight:
//                {
//                    NSArray *highlights = [responseDic objectForKey:kHighlights];
//                    [ACUtility postNotificationName:kNetCenterSearchHighLightNotifation object:[NSDictionary dictionaryWithObject:highlights forKey:object]];
//                }
//                    break;
                case ACFile_Type_SearchCount:
                {
                    [ACUtility postNotificationName:kNetCenterSearchCountNotifation object:responseDic];
                }
                    break;
                case ACFile_Type_ChangePassword:
                {
                    ...
                    [defaults synchronize];
                    [ACUtility postNotificationName:kNetCenterChangePasswordNotifation object:nil];
                }
                    break;
                case ACFile_Type_GetCategories:
                {
                    ...
                    [ACUtility postNotificationName:kNetCenterGetCategoriesNotifation object:categories];
                }
                    break;
                case ACFile_Type_GetSuitsOfCategory:
                {
                    NSArray *suits = [ACSuit suitArrayWithDicArray:[responseDic objectForKey:kSuits]];
                    [ACUtility postNotificationName:kNetCenterGetSuitsOfCategoryNotifation object:suits];
                }
                    break;
                case ACFile_Type_GetUserOwnStickers:
                {
                    NSArray *suits = [ACSuit suitArrayWithDicArray:[responseDic objectForKey:kSuits]];
                    [ACUtility postNotificationName:kNetCenterGetUserOwnStickersNotifation object:suits];
                }
                    break;
                case ACFile_Type_RemoveUserOwnSticker:
                {
                    NSString *suitID = object;
                    [ACUtility postNotificationName:kNetCenterRemoveUserOwnStickerNotifation object:suitID];
                }
                    break;
...
//                    [data writeToFile:saveAddress atomically:YES];
                    if (isSuccess)
                    {
                        ...
                        [ACUtility postNotificationName:kNetCenterAddAndSuitDownloadNotifation object:suit];
                    }
                    else
                    {
...
//                    [data writeToFile:saveAddress atomically:YES];
                    if (isSuccess)
                    {
                        ...
                        [ACUtility postNotificationName:kNetCenterSuitDownloadNotifation object:suit];
                    }
                    else
                    {
...
//                        if(isNotNull)
                        {
                            [ACUtility postNotificationName:kNetCenterDownloadStickerNotifation object:nil];
                        }
                    });
                }
                    break;
                ...
                {
                    NSArray *suits = [ACSuit suitArrayWithDicArray:[responseDic objectForKey:kSuits]];
                    [ACUtility postNotificationName:kNetCenterGetAllSuitsNotifation object:suits];
                }
                    break;
...
//                {
//                    [ACUtility postNotificationName:kNetCenterNotes_Note_LoadList_Notifition object:[responseDic objectForKey:@"notes"]];
//                }
//                    break;
//                case ACFile_Type_NoteComment_List_Json:
//                {
//                    [ACUtility postNotificationName:kNetCenterNotes_Comment_LoadList_Notifition object:[responseDic objectForKey:@"comments"]];
//                }
//                    break;
                default:
                    break;
...
//TXB 避免使用.mm                   throw 1;
            ...
            {
                self.sendNoteOrWallboardRequest = nil;
                [ACUtility postNotificationName:kNetCenterNotes_Note_Upload_Fail_Notifition object:object];
...
//                pAcConfigs.isLogouting = NO;
                ...
                [ACUtility postNotificationName:kNetCenterGetChatMessageNotifation object:nil];
            }
            else if (fileType == ACFile_Type_SendHasBeenReadTopic)
            {
                [ACUtility postNotificationName:kNetCenterNetworkFailNotifation object:nil];
            }
            else if (fileType == ACFile_Type_GetReadCount_Json)
            {
                NSString *topicEntityID = fileNameID;
            ...
            else if (fileType == ACFile_Type_GetSingleReadSeq_Json)
            {
                ...
                readSeq.topicEntityID = topicEntityID;
                readSeq.seq = -1;
                [ACUtility postNotificationName:kNetCenterGetReadSeqFailNotifation object:readSeq];
            }
        });
    }];
