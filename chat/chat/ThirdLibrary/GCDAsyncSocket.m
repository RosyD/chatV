...
#define LogObjc(flg, frmt, ...) NSLog(@"%@",[NSString stringWithFormat:frmt,## __VA_ARGS__])
#define LogC(flg, frmt, ...)    NSLog(@"%@",[NSString stringWithFormat:frmt,## __VA_ARGS__])

#define LogError(frmt, ...)     NSLog(@"%@",[NSString stringWithFormat:frmt,## __VA_ARGS__])
#define LogWarn(frmt, ...)      NSLog(@"%@",[NSString stringWithFormat:frmt,## __VA_ARGS__])
#define LogInfo(frmt, ...)      NSLog(@"%@",[NSString stringWithFormat:frmt,## __VA_ARGS__])
#define LogVerbose(frmt, ...)   NSLog(@"%@",[NSString stringWithFormat:frmt,## __VA_ARGS__])

#define LogCError(frmt, ...)    NSLog(@"%@",[NSString stringWithFormat:frmt,## __VA_ARGS__])
#define LogCWarn(frmt, ...)     NSLog(@"%@",[NSString stringWithFormat:frmt,## __VA_ARGS__])
#define LogCInfo(frmt, ...)     NSLog(@"%@",[NSString stringWithFormat:frmt,## __VA_ARGS__])
#define LogCVerbose(frmt, ...)  NSLog(@"%@",[NSString stringWithFormat:frmt,## __VA_ARGS__])

#define LogTrace()              NSLog( @"%@", NSStringFromSelector(_cmd))
#define LogCTrace()             NSLog( @"%@", NSStringFromSelector(_cmd))

#define GCDAsyncSocketLogLevel 1
...
//        ssize_t result = send(socketFD, buffer, (size_t)bytesToWrite,MSG_WAITALL);
