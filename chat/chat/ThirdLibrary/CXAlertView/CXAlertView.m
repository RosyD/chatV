...
- (void)updateContentScrollView
{
    ...
    if (_contentView) {
        ...
        [_contentScrollView setContentOffset:CGPointMake((_contentScrollView.contentSize.width-_contentScrollView.bounds.size.width)/2, (_contentScrollView.contentSize.height-_contentScrollView.bounds.size.height)/2)];
        [_contentScrollView setScrollEnabled:NO/*([self heightForContentScrollView] < CGRectGetHeight(_contentView.frame))*/];
    }
    else {
