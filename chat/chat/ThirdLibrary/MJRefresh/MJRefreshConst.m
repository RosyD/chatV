...
NSString *const MJRefreshFooterReleaseToRefresh = @"Load more";
NSString *const MJRefreshFooterRefreshing = @"Loading...";

NSString *const MJRefreshHeaderPullToRefresh = @"Refresh";
NSString *const MJRefreshHeaderReleaseToRefresh = @"Refresh";
NSString *const MJRefreshHeaderRefreshing = @"Refreshing...";
