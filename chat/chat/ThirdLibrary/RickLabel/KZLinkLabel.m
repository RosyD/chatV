...
- (void)setupTextSystem
{
    ...
    _linkBackgroundColor = [UIColor colorWithWhite:0.95 alpha:1.0];
    _linkColor = [UIColor blueColor];
    _linkHighlightColor = [UIColor redColor];
...
-(void)setNomalText:(NSString*)text{
    BOOL bOld = _automaticLinkDetectionEnabled;
    _automaticLinkDetectionEnabled = NO;
    self.text =    text;
    _automaticLinkDetectionEnabled = bOld;
}
...
-(NSDictionary*)labelTap:(UITapGestureRecognizer *)tap
{
    CGPoint point = [tap locationInView:self];
    return [self getLinkAtLocation:point];
}
