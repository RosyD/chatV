...
- (CGRect)frameForSelectionIndicator {
    ...
    CGFloat fHight = self.size.height-self.selectionIndicatorHeight;
    ...
    if (self.selectionIndicatorMode == HMSelectionIndicatorResizesToStringWidth) {
        ...
        return CGRectMake(x, fHight, stringWidth, self.selectionIndicatorHeight);
    } else {
        return CGRectMake(self.segmentWidth * self.selectedIndex, fHight, self.segmentWidth, self.selectionIndicatorHeight);
    }
}
