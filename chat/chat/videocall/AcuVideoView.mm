...
@interface AcuVideoView ()
{
    ...
    CGRect _videoRealRect;
    
    BOOL _bFrameBufferOK;
}
...
//    }
    ...
    _videoRealRect = self.layer.bounds;
    _bFrameBufferOK = YES;
...
//		if (frameWidth <= 0)
//		{
//			NSLog(@"frame width = %d from pixelBuffer", frameWidth);
//			return;
//		}
//		else
//		{
...
//		if (frameHeight <= 0)
//		{
//			NSLog(@"frame height = %d from pixelBuffer", frameHeight);
//			return;
//		}
//		else
//		{
...
//          self.frame.size.height);
    ...
    _videoRealRect = vertexSamplingRect;
    
	// Compute normalized quad coordinates to draw the frame into.
	CGSize normalizedSamplingSize = CGSizeMake(0.0, 0.0);
	CGSize cropScaleAmount = CGSizeMake(vertexSamplingRect.size.width/self.layer.bounds.size.width,
                                        vertexSamplingRect.size.height/self.layer.bounds.size.height);
	...
	glBindRenderbuffer(GL_RENDERBUFFER, _colorBufferHandle);
	BOOL bRender = [_context presentRenderbuffer:GL_RENDERBUFFER];
    if (!bRender) {
